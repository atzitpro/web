...
- 破壁穿墙、突破网络封锁的方式大致可分为两种
  - 第一种是代理方式
  - 第二种是VPN方式
- VPN是英文Virtual Private Network的缩写。译为中文是“虚拟专用网络”。
- VPN的特点是：在国际互联网这根巨大的、保密性最差的管道里，为特定VPN用户专门构建一根毛细管道，流淌在这根毛细管道里的信息被加密，令当今世界最凶恶、最邪恶、最具Power的GFW这样的封网巨兽也无法破解、无法嗅探、无法阻断其通讯
