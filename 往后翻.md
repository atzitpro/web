...
### 绿色通道
- 若持<strong> 安卓类手机/平板（如华为、OPPO、VIVO等）</strong>
  - 请点击以下两行蓝色文字之一下载安装最新版金刚app
    - [下载链接1](https://github.com/a2zitpro/client/releases/download/latest/app-prod-release.apk) 
    - [下载链接2](https://bitbucket.org/kk64/public/downloads/app-prod-release.apk) 
    ...
    - <font color="red">如果点击以上蓝色文字无响应，请在<Strong>另一个浏览器</Strong>的地址栏里严格按大小写录入以下这男字母、数字，然后点 <strong>前往</strong> </font>
      - cutt.ly/3h2RXJF 
