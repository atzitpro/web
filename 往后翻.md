...
- 若持<strong> 安卓类手机/平板</strong>（如华为、OPPO、VIVO等）
  - 请点击以下两行蓝色文字之一下载安装最新版金刚app<br>
    - [下载链接1](https://github.com/a2zitpro/client/releases/download/latest/app-prod-release.apk) <br>
    - [下载链接2](https://bitbucket.org/kk64/public/downloads/app-prod-release.apk) <br>
